...
import com.progressoft.impl.CsvTransactionProcessorImpl;
...
public class CsvTransactionProcessorTest {
    ...
    @Before
    public void setUp() {
        csvTransactionProcessor = new CsvTransactionProcessorImpl();// replace the null with your CSV implementation class
    }
