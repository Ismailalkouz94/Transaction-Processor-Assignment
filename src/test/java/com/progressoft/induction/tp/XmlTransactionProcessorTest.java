...
import com.progressoft.impl.XmlTransactionProcessorImpl;
...
public class XmlTransactionProcessorTest {
    ...
    @Before
    public void setUp() {
        xmlTransactionProcessor = new XmlTransactionProcessorImpl();// replace the null with your XML implementation class
    }
